...
<?php 	include "../Auth/connection.php";
	...
	<div class="topnav">
		...
		<a <?php if (basename($_SERVER['PHP_SELF']) == "Class.php") echo "class='active'"?>href="Class.php">Class</a>
		<a <?php if (basename($_SERVER['PHP_SELF']) == "Students.php") echo "class='active'"?>href="Students.php">Students</a>
